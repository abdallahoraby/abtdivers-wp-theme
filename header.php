...
<div id="page" class="site wrapper">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark navbar-offcanvas">
        <div class="top-header">
            <ul class="navbar-nav ml-auto mt-3 mt-lg-0 social-icons hide-mobile">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav mr-auto pl-lg-4 main-menu hide-mobile">
            ...
            <div class="navbar-collapse collapse ml-auto" id="navbar-mobile">
                <div class="menu-content">
                    <img class="logo-mobile" src="<?php echo esc_url( $abtdivers['site_logo']['url'] ); ?>" alt="">
                    <h3 class="text-center"> Abtdivers.com </h3>
                    ...
                    <ul class="navbar-nav mr-auto pl-lg-4 main-menu">
                        ...
                        foreach ($menu as $menu_item):
                            ...
                            if( count($menu_item_children) > 0 ){
                                ...
                                $a_dropdown_id = 'dropdown' . $menu_item_id;
                                $a_dropdown_data_toggle = ' data-toggle="dropdown" ';
                                $show_arrow = '<i class="fas fa-chevron-down"></i>';
                            } else {
                                $li_dropdown_class = '';
                                $a_dropdown_class = '';
                                $a_dropdown_id = '';
                            ...
                            <li class="nav-items px-lg-2 <?php echo $li_dropdown_class; ?> ">
                                <a class="nav-link <?php echo $a_dropdown_class; ?>" <?php echo $a_dropdown_id;?> <?php echo $a_dropdown_data_toggle;?> href="<?php echo $menu_item_url; ?>">
                                    <span class="d-inline-block d-lg-none icon-width"></span>
                                    <?php echo $menu_item_title; ?>
                                    <?php echo  $show_arrow; ?>
                                </a>

                                <?php if( count($menu_item_children) > 0 ): ?>
                                    <div class="dropdown-menus shadow-sm sm-menu" aria-labelledby="<?php echo $a_dropdown_id;?>">
                    ...
                    <div class="social-menu-list">
                        <ul class="navbar-nav ml-auto mt-3 mt-lg-0 social-icons-mobile">
